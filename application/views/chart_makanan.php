...
<html lang="en">
  ...
  <body>
    <form role="form" method="post" action="<?= base_url('C_logistik/tampilLogMak');?>">
            ...
            <table class="table table-hover table-sm">
              ...
              <tbody>
                <?php foreach($data as $v): ?>
                  <tr>
                    <td style="text-align: center;"><?php echo $v["id_makanan"]; ?></td>
                    <td><?php echo $v["nama_makanan"]; ?></td>
                    <td style="text-align: center;"><?php echo $v["jum_makanan"]; ?></td>
                    <td><a class="btn btn-outline-dark" href="<?php echo base_url() ?>C_logistik/editM/<?php echo$v['id_makanan'] ?>"><i class="fa fa-pencil" ></i></a></td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
    ...
    <script>
      ...
      var myChart = new Chart(ctx, {
        type: 'line',
        data: {
          labels: [<?php foreach ($abc as $key) {
            echo '"'; echo $key->nama_makanan; echo '"'; echo ',';
          }?>],
          datasets: [{
            data: [<?php foreach ($abc as $key) {
              echo $key->jum_makanan; echo ',';
            } ?>],
            lineTension: 0,
