  ...
  <body>
            ...
            <table class="table table-hover table-sm">
              ...
              <tbody>
                <?php foreach($data as $v): ?>
                  <tr>
                    <td style="text-align: center;"><?php echo $v["id_pakaian"]; ?></td>
                    <td ><?php echo $v["nama_pakaian"]; ?></td>
                    <td style="text-align: center;"><?php echo $v["jum_pakaian"]; ?></td>
                    <td><a class="btn btn-outline-dark" name="update" href="<?php echo base_url() ?>C_logistik/editP/<?php echo$v['id_pakaian'] ?>"><i class="fa fa-pencil"></i></a></td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
    ...
    <script>
      ...
      var myChart = new Chart(ctx, {
        type: 'line',
        data: {
          labels: [<?php foreach ($pak as $key) {
            echo '"'; echo $key->nama_pakaian; echo '"'; echo ',';
          }?>],
          datasets: [{
            data: [<?php foreach ($pak as $key) {
              echo $key->jum_pakaian; echo ',';
            } ?>],
            lineTension: 0,
