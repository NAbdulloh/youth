    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <form action="<?php echo base_url('C_logistik/updateMak');?>" method="post">
            <fieldset>
            <legend>Data Logistik</legend>
        <div class="form-group col">
          <label>ID Makanan</label>
            <input class="form-control" name="id" value="<?php echo $v->id_makanan ?>" ></input>
        </div>
        <div class="form-group col">
            <label>Nama Obat</label>
            <input class="form-control" name="namaP" value="<?php echo $v->nama_makanan ?>" disabled>
            </input>
        </div>
        <div class="form-group col-md-2">
          <label>Jumlah</label>
          <input type="number" class="form-control" name="jmlh" placeholder="jumlah" value="<?php echo $v->jum_makanan ?>">
        </div>
